...
#ESC
    order_button = QtWidgets.QPushButton('Формирование заказа', win1)
...
#F3(поиск)
    history_button = QtWidgets.QPushButton('История входа', win1)
    history_button.setStyleSheet('font:18px;')
    history_button.setGeometry( 150, 0, button_width, button_height )
...
##    sorting_button.clicked.connect(sorting)
    ...
    buttonLayout.addWidget(history_button)
