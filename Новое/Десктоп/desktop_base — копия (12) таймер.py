...
class main_class_label(QtWidgets.QLabel):
...
##        G.label_name.setText( time.strftime("%H:%M:%S") )
...
#        layout = QVBoxLayout()
        ...
        self.label = QLabel(parent = G.mainwin)
...
##        self.timer_0 = QtWidgets.QLabel( '00:00:00', parent = G.mainwin )#, parent = top_label)
##        self.timer_0.setWindowFlags(QtCore.Qt.Window)
##        self.timer_0.setGeometry(0, 0, 200, 200)
##        
...
##        self.timer_0.setText(label_time)
...
##    G.timer_label = QtWidgets.QLabel( '00:00:00', parent = top_label)
##    G.timer_label.setGeometry(0, 0, 200, 200)
    
    win1.timer_id = win1.startTimer( 1000, timerType = QtCore.Qt.VeryCoarseTimer )
    time.sleep(.01)
